...
def create_product_catalog(l1_count, l2_avg_count, l3_avg_count):
    ...
    write_lines('retail/product_catalog.json', json_lines)
...
def create_stores(count):
    ...
    write_lines('retail/stores.json', json_lines)
...
def create_customers(count):
    ...
    write_lines('retail/customers.json', json_lines)
...
def create_sales_data(start_date, end_date, avg_count_day, avg_item_count):
    ...
    products  = read_json_objects('retail/product_catalog.json')
    stores    = read_json_objects('retail/stores.json')
    customers = read_json_objects('retail/customers.json')
...
def slice_sales_data(separator_date):
    ...
    infile = 'retail/sales.json'
    file1  = 'retail/sales1.json'
    file2  = 'retail/sales2.json'
